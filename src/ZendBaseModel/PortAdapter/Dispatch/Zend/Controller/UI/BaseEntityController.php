...
use ZendBaseModel\PortAdapter\Dispatch\Zend\Form\SearchForm;
use ZendBaseModel\PortAdapter\Doctrine\Repository\BaseRepositoryInterface;
...
abstract class BaseEntityController extends BaseController
{
     ...
     * @var
     */
    protected $defaultSearchFormClassName = SearchForm::class;
